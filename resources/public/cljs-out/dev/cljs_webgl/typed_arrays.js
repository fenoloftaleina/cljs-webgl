...
return (new Int8Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Uint8Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Uint8ClampedArray(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Int16Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Uint16Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Int32Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Uint32Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Float32Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
...
return (new Float64Array(cljs.core.clj__GT_js.call(null,collection)));
});
/**
