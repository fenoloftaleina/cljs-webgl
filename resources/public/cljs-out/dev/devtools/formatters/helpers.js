...
var G__9579 = devtools.prefs.pref.call(null,v);
v = G__9579;
continue;
} else {
return v;
...
}catch (e9582){var _e__8596__auto__ = e9582;
return false;
}})();
...
}catch (e9586){var _e__8596__auto__ = e9586;
return false;
}})();
...
}catch (e9588){var _e__8596__auto__ = e9588;
return false;
}}
}
});
...
var vec__9590 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9590,(0),null);
var name = cljs.core.nth.call(null,vec__9590,(1),null);
...
return cljs.core.some.call(null,(function (p1__9593_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9593_SHARP_);
}),template);
});
